...
class ClipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clip" do
    assert_difference("Clip.count") do
      post clips_url, params: { clip: { date: @clip.date, description: @clip.description, id: @clip.id, title: @clip.title, video_id: @clip.video_id } }
    end
  ...
  test "should update clip" do
    patch clip_url(@clip), params: { clip: { date: @clip.date, description: @clip.description, id: @clip.id, title: @clip.title, video_id: @clip.video_id } }
